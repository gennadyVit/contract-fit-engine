...
PROFILES = {
    ...
    "apexeng": {
        ...
        "set_asides": ["SBA"],
        "clearances": [],
        "min_contract_value": 200_000,
        "max_contract_value": 20_000_000,
        "keywords": ["engineering", "electrical", "mechanical", "construction", "sustainment",
                     "facility", "systems", "design", "infrastructure", "support"],
        "past_agencies": ["Department of Defense", "Veterans Affairs, Department of",
                          "Interior, Department of the"],
        "location_states": ["VA", "MD", "DC", "TX", "GA"],
        "embedding": None,
    },
    "cyberops": {
        ...
        "keywords": ["cybersecurity", "PKI", "security", "network", "IT support",
                     "infrastructure", "systems", "software", "DoD", "NIST"],
        "past_agencies": ["Department of Defense", "Department of Homeland Security",
                          "Department of Veterans Affairs"],
        "location_states": ["VA", "MD", "DC"],
        "embedding": None,
    },
}
